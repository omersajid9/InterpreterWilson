...
import static wilson.TokenType.*;
...
class Parser
{
    ...
    {
        Token name = consume(IDENTIFIER, "Expected function name after 'fun'");
        ...
        if (!check(TokenType.RIGHT_PAREN))
        {
            do
            {
                ...
                params.add(consume(IDENTIFIER, "Exptected parameter name"));
            }
            while (match(COMMA));
        }
        consume(RIGHT_PAREN, "Expected ')' after function declaration");
    ...
    private Stmt whileStatement()
    {
        ...
        consume(RIGHT_PAREN, "Expected ')' after expression for 'while'.");
        Stmt body = statement();
    ...
    private Stmt ifStatement()
    {
        ...
        Expr expr = expression();
        consume(RIGHT_PAREN, "Expected ')' after expression for 'if'.");
    ...
    private Stmt printStatement()
    {
        ...
        {
            consume(COMMA, "Expect ',' between print expressions");
    ...
    {
        Wilson.error(token, errorMessage);
